...
export class ApiClient {
     ...
     * @return Success
     */
    getLookup(lookupType: string, page: number, size: number, sort?: string | null, search?: string | null): Observable<ResultSetOfLookupEntry> {
     ...
     * @return Success
     */
    getCountries(page: number, size: number, sort?: string | null, search?: string | null): Observable<ResultSetOfCountryInfo> {
     ...
     * @return Success
     */
    getCurrencies(page: number, size: number, sort?: string | null, search?: string | null): Observable<ResultSetOfCurrencyInfo> {
     ...
     * @return Success
     */
    getSubscriptions(page: number, size: number, filter_Code?: string | null, filter_MemberId?: string | null, sort?: string | null, search?: string | null): Observable<ResultSetOfSubscriptionInfo> {
     ...
     * @return Success
     */
    getContacts(subscriptionId: string, page: number, size: number, filter_Code?: string | null, sort?: string | null, search?: string | null): Observable<ResultSetOfContactInfo> {
     ...
     * @return Success
     */
    getCompaniesByContact(subscriptionId: string, contactId: string, page: number, size: number, filter_Customers?: boolean | null, filter_Suppliers?: boolean | null, filter_Code?: string | null, sort?: string | null, search?: string | null): Observable<ResultSetOfOrganisationInfo> {
     ...
     * @return Success
     */
    getDocuments(subscriptionId: string, page: number, size: number, summary: boolean, filter_Number?: string | null, filter_From?: Date | null, filter_To?: Date | null, filter_Status?: Status[] | null, filter_RecipientCode?: string | null, filter_RecipientId?: string | null, filter_TypeId?: string[] | null, filter_PaymentCode?: string | null, sort?: string | null, search?: string | null): Observable<ResultSetOfDocumentInfo> {
     ...
     * @return Success
     */
    getDocumentPayments(subscriptionId: string, documentId: string, page: number, size: number, sort?: string | null, search?: string | null): Observable<ResultSetOfPaymentInfo> {
     ...
     * @return Success
     */
    updateDocumentPaymentState(subscriptionId: string, documentId: string, transactionId: string, approval?: UpdateApprovalRequest | null): Observable<void> {
     ...
     * @return Success
     */
    getViews(subscriptionId: string, documentId: string, page: number, size: number, sort?: string | null, search?: string | null): Observable<ResultSetOfTrackingInfo> {
     ...
     * @return Success
     */
    getDocumentTypes(subscriptionId: string, page: number, size: number, sort?: string | null, search?: string | null): Observable<ResultSetOfDocumentTypeInfo> {
     ...
     * @return Success
     */
    getPaymentOptions(subscriptionId: string, documentTypeId: string, page: number, size: number, sort?: string | null, search?: string | null): Observable<ResultSetOfPaymentOptionInfo> {
     ...
     * @return Success
     */
    getSubscriptionMembers(subscriptionId: string, page: number, size: number, sort?: string | null, search?: string | null): Observable<ResultSetOfSubscriptionMemberInfo> {
     ...
     * @return Success
     */
    getSubscriptionMetrics(subscriptionId: string, page: number, size: number, filter_From?: Date | null, filter_To?: Date | null, sort?: string | null, search?: string | null): Observable<ResultSetOfMetricsRecord> {
     ...
     * @return Success
     */
    getOrganisations(subscriptionId: string, page: number, size: number, filter_Customers?: boolean | null, filter_Suppliers?: boolean | null, filter_Code?: string | null, sort?: string | null, search?: string | null): Observable<ResultSetOfOrganisationInfo> {
     ...
     * @return Success
     */
    getPaymentOptions2(subscriptionId: string, page: number, size: number, sort?: string | null, search?: string | null): Observable<ResultSetOfPaymentOptionInfo> {
     ...
     * @return Success
     */
    getPaymentOptionDocumentTypes(subscriptionId: string, paymentOptionId: string, page: number, size: number, sort?: string | null, search?: string | null): Observable<ResultSetOfDocumentTypeInfo> {
     ...
     * @return Success
     */
    getTransactions(subscriptionId: string, paymentOptionId: string, page: number, size: number, filter_BatchId?: string | null, filter_From?: Date | null, filter_To?: Date | null, sort?: string | null, search?: string | null): Observable<ResultSetOfTransactionInfo> {
     ...
     * @return Success
     */
    getTransactionPayments(subscriptionId: string, paymentOptionId: string, transactionId: string, page: number, size: number, sort?: string | null, search?: string | null): Observable<ResultSetOfPaymentInfo> {
     ...
     * @return Success
     */
    updateSubscriptionService(subscriptionId: string, serviceId: string, request?: UpdateServiceRequest | null): Observable<Service> {
     ...
     * @return Success
     */
    getProducts(subscriptionId: string, page: number, size: number, sort?: string | null, search?: string | null): Observable<ResultSetOfProductInfo> {
     ...
     * @return Success
     */
    getSubscriptionsGlobal(page: number, size: number, filter_Code?: string | null, filter_MemberId?: string | null, sort?: string | null, search?: string | null): Observable<ResultSetOfSubscriptionInfo> {
     ...
     * @return Success
     */
    getGlobalMetrics(page: number, size: number, filter_From?: Date | null, filter_To?: Date | null, sort?: string | null, search?: string | null): Observable<ResultSetOfMetricsRecord> {
     ...
     * @return Success
     */
    getTimeZones(page: number, size: number, sort?: string | null, search?: string | null): Observable<ResultSetOfTimeZone> {
...
export class CreateSubscriptionRequest {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.plan = data["plan"] ? Plan.fromJS(data["plan"]) : new Plan();
            this.notes = data["notes"];
            if (data["customData"]) {
                this.customData = {};
                for (let key in data["customData"]) {
